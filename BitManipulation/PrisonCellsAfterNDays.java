...
class PrisonCellsAfterNDays{
    public static void main(String[] args){
        ...
        // l.add(nums.toString());
        // String ref=nums.toString();
        
        // int[] dummy=new int[8];
        // while(true){
        //     // if(dummy.toString()==ref) break;
        //     dummy[0]=0;
        //     dummy[7]=0;
        //     for(int i=1;i<7;i++){
        //         if(nums[i-1]==nums[i+1]) dummy[i]=1;
        //         else dummy[i]=0;
        //     }
        //     if(l.contains(Arrays.toString(dummy))) break;
        //     l.add(Arrays.toString(dummy));
        //     // System.out.println(Arrays.toString(nums));
        //     // nums=dummy;
        //     for(int i=0;i<8;i++) nums[i]=dummy[i];
        ...
        // System.out.print(l.get(day%l.size()));
        
        int[] dummy=new int[8];
        for(int j=0;j<day;j++){
            dummy[0]=0;
            dummy[7]=0;
            for(int i=1;i<7;i++) dummy[i]=1-(nums[i-1]^nums[i+1]);
            for(int i=0;i<8;i++) nums[i]=dummy[i];
        }
